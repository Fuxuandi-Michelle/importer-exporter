...
public enum DBImporterEnum {
	...
	//multiGeometry
	POINT_LINE_GEOMETRY(CITYOBJECT),
	SURFACE_OF_MULTI_GEOMETRY(CITYOBJECT),
	MULTI_GEOMETRY(CITYOBJECT,SURFACE_OF_MULTI_GEOMETRY,POINT_LINE_GEOMETRY, IMPLICIT_GEOMETRY),
	...
	BUILDING_FURNITURE(CITYOBJECT, ROOM, SURFACE_GEOMETRY, IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	BUILDING_INSTALLATION(CITYOBJECT, BUILDING, ROOM, SURFACE_GEOMETRY, IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	
	//buildingExtra
	
	PODIUM(CITYOBJECT,BUILDING,SURFACE_GEOMETRY),
	STOREY(CITYOBJECT,BUILDING,PODIUM,SURFACE_GEOMETRY),
	BEAM(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	BUILDING_COLUMN(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	COVERING(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	FLOW_TERMINAL(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	RAILING(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	RAMP(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	RAMP_FLIGHT(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	SLAB(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	STAIR(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
	STAIR_FLIGHT(CITYOBJECT,BUILDING,PODIUM,STOREY,SURFACE_GEOMETRY,IMPLICIT_GEOMETRY,MULTI_GEOMETRY),
